...
model=YOLO("SAMPLE MODEL OR TRAINED MODEL")
...
# transform predict data in form of torch.tensor to numpy array and the dictionary label_dict can have multiple values depending on classes
